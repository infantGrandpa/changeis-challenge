...
|-----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|----------|
| **Must Have**         | **Setup React Project (30 mins)**<br>Connect to Faker API (1 hr)<br>Create basic page to show data (30 mins)<br>Create Documentation (30 mins)<br>Upload to GitHub (30 mins) | Create project plan (30 mins)<br> |          |
