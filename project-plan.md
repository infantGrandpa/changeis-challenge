...
|-----------------------|----------------------------------------------------------------------------------------------------------|---------------------------------|----------------------------------------------------------------|
| **Must Have**         | Create basic page to show data (30 mins)<br>Create Documentation (30 mins)<br>Upload to GitHub (30 mins) | Connect to Faker API (1 hr)<br> | Create project plan (30 mins)<br>Setup React Project (30 mins) | 
